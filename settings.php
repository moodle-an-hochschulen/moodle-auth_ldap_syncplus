...
if ($ADMIN->fulltree) {
    if (!function_exists('ldap_connect')) {
        ...
        $settings->add(new admin_setting_heading(
            'auth_ldap_syncplus/ldapserversettings',
        ...
        $settings->add(new admin_setting_configselect(
            'auth_ldap_syncplus/ldap_version',
        ...
        // Encoding.
        $settings->add(new admin_setting_configtext(
            'auth_ldap_syncplus/ldapencoding',
        ...
        // Bind settings.
        $settings->add(new admin_setting_heading(
            'auth_ldap_syncplus/ldapbindsettings',
        ...
        $settings->add(new admin_setting_configselect(
            'auth_ldap_syncplus/preventpassindb',
            new lang_string('auth_ldap_preventpassindb_key', 'auth_ldap'),
            new lang_string('auth_ldap_preventpassindb', 'auth_ldap'),
            0,
            $yesno
        ));
        ...
        $settings->add(new admin_setting_heading(
            'auth_ldap_syncplus/ldapuserlookup',
        ...
        $settings->add(new admin_setting_configselect(
            'auth_ldap_syncplus/opt_deref',
            new lang_string('auth_ldap_opt_deref_key', 'auth_ldap'),
            new lang_string('auth_ldap_opt_deref', 'auth_ldap'),
            LDAP_DEREF_NEVER,
            $optderef
        ));
        ...
        $settings->add(new auth_ldap_admin_setting_special_lowercase_configtext(
            'auth_ldap_syncplus/user_attribute',
        ...
        // Suspended attribute.
        $settings->add(new auth_ldap_admin_setting_special_lowercase_configtext(
            'auth_ldap_syncplus/suspended_attribute',
        ...
        // Member attribute.
        $settings->add(new auth_ldap_admin_setting_special_lowercase_configtext(
            'auth_ldap_syncplus/memberattribute',
        ...
        $settings->add(new admin_setting_configselect(
            'auth_ldap_syncplus/memberattribute_isdn',
        ...
        // Object class.
        $settings->add(new admin_setting_configtext(
            'auth_ldap_syncplus/objectclass',
        ...
        $settings->add(new admin_setting_heading(
            'auth_ldap_syncplus/ldapforcepasswordchange',
        ...
        $settings->add(new admin_setting_configselect(
            'auth_ldap_syncplus/forcechangepassword',
            new lang_string('forcechangepassword', 'auth'),
            new lang_string('forcechangepasswordfirst_help', 'auth'),
            0,
            $yesno
        ));
        ...
        $settings->add(new admin_setting_configselect(
            'auth_ldap_syncplus/passtype',
            new lang_string('auth_ldap_passtype_key', 'auth_ldap'),
            new lang_string('auth_ldap_passtype', 'auth_ldap'),
            'plaintext',
            $passtype
        ));
        ...
        // Password change URL.
        $settings->add(new admin_setting_configtext(
            'auth_ldap_syncplus/changepasswordurl',
            get_string('auth_ldap_changepasswordurl_key', 'auth_ldap'),
            get_string('changepasswordhelp', 'auth'),
            '',
            PARAM_URL
        ));
        ...
        $settings->add(new admin_setting_heading(
            'auth_ldap_syncplus/passwordexpire',
        ...
        $settings->add(new admin_setting_configtext(
            'auth_ldap_syncplus/expiration_warning',
            get_string('auth_ldap_expiration_warning_key', 'auth_ldap'),
            get_string('auth_ldap_expiration_warning_desc', 'auth_ldap'),
            '',
            PARAM_RAW
        ));
        ...
        $settings->add(new auth_ldap_admin_setting_special_lowercase_configtext(
            'auth_ldap_syncplus/expireattr',
            get_string('auth_ldap_expireattr_key', 'auth_ldap'),
            get_string('auth_ldap_expireattr_desc', 'auth_ldap'),
            '',
            PARAM_RAW
        ));
        ...
        // Grace Logins.
        $settings->add(new admin_setting_configselect(
            'auth_ldap_syncplus/gracelogins',
            new lang_string('auth_ldap_gracelogins_key', 'auth_ldap'),
            new lang_string('auth_ldap_gracelogins_desc', 'auth_ldap'),
            0,
            $yesno
        ));
        ...
        $settings->add(new auth_ldap_admin_setting_special_lowercase_configtext(
            'auth_ldap_syncplus/graceattr',
            get_string('auth_ldap_gracelogin_key', 'auth_ldap'),
            get_string('auth_ldap_graceattr_desc', 'auth_ldap'),
            '',
            PARAM_RAW
        ));
        ...
        // User Creation.
        $settings->add(new admin_setting_heading(
            'auth_ldap_syncplus/usercreation',
        ...
        $settings->add(new admin_setting_configselect(
            'auth_ldap_syncplus/auth_user_create',
            new lang_string('auth_ldap_auth_user_create_key', 'auth_ldap'),
            new lang_string('auth_user_creation', 'auth'),
            0,
            $yesno
        ));
        ...
        $settings->add(new admin_setting_configtext(
            'auth_ldap_syncplus/create_context',
            get_string('auth_ldap_create_context_key', 'auth_ldap'),
            get_string('auth_ldap_create_context', 'auth_ldap'),
            '',
            PARAM_RAW_TRIMMED
        ));
        ...
        $settings->add(new admin_setting_heading(
            'auth_ldap_syncplus/systemrolemapping',
        ...
        foreach ($roles as $role) {
            ...
            if (core_text::strlen($role['settingname']) > 100 || !preg_match('/^[a-zA-Z0-9_]+$/', $role['settingname'])) {
                ...
                $a = (object)['rolename' => $role['localname'], 'shortname' => $role['shortname'], 'charlimit' => 93,
                              'link' => $url->out(), ];
                $settings->add(new admin_setting_heading(
                    'auth_ldap_syncplus/role_not_mapped_' . sha1($role['settingname']),
                    '',
                    get_string('cannotmaprole', 'auth_ldap', $a)
                ));
            } else {
                $settings->add(new admin_setting_configtext(
                    'auth_ldap_syncplus/' . $role['settingname'],
                    get_string('auth_ldap_rolecontext', 'auth_ldap', $role),
                    get_string('auth_ldap_rolecontext_help', 'auth_ldap', $role),
                    '',
                    PARAM_RAW_TRIMMED
                ));
            }
        ...
        $settings->add(new admin_setting_configtext(
            'auth_ldap_syncplus/removeuser_graceperiod',
            new lang_string('removeuser_graceperiod', 'auth_ldap_syncplus'),
            new lang_string('removeuser_graceperiod_desc', 'auth_ldap_syncplus'),
            10,
            PARAM_INT
        ));
        ...
        $settings->add(new admin_setting_configselect(
            ...
            new lang_string('sync_script_createuser_enabled', 'auth_ldap_syncplus'),
            1,
            $yesno
        ));
        ...
        // Sync Suspension.
        $settings->add(new admin_setting_configselect(
            'auth_ldap_syncplus/sync_suspended',
        ...
        $settings->add(new admin_setting_configtext(
            'auth_ldap_syncplus/sync_updateuserchunk',
            new lang_string('sync_updateuserchunk_key', 'auth_ldap'),
            new lang_string('sync_updateuserchunk', 'auth_ldap'),
            1000,
            PARAM_INT
        ));
        ...
        // Enable NTLM.
        $settings->add(new admin_setting_configselect(
            'auth_ldap_syncplus/ntlmsso_enabled',
            new lang_string('auth_ntlmsso_enabled_key', 'auth_ldap'),
            new lang_string('auth_ntlmsso_enabled', 'auth_ldap'),
            0,
            $yesno
        ));
        ...
        // Subnet.
        $settings->add(new admin_setting_configtext(
            'auth_ldap_syncplus/ntlmsso_subnet',
            get_string('auth_ntlmsso_subnet_key', 'auth_ldap'),
            get_string('auth_ntlmsso_subnet', 'auth_ldap'),
            '',
            PARAM_RAW_TRIMMED
        ));
        ...
        $settings->add(new admin_setting_configselect(
            'auth_ldap_syncplus/ntlmsso_ie_fastpath',
        ...
        $settings->add(new admin_setting_configselect(
            'auth_ldap_syncplus/ntlmsso_type',
            new lang_string('auth_ntlmsso_type_key', 'auth_ldap'),
            new lang_string('auth_ntlmsso_type', 'auth_ldap'),
            'ntlm',
            $types
        ));

        // Remote Username format.
        $settings->add(new auth_ldap_admin_setting_special_ntlm_configtext(
            'auth_ldap_syncplus/ntlmsso_remoteuserformat',
            get_string('auth_ntlmsso_remoteuserformat_key', 'auth_ldap'),
            get_string('auth_ntlmsso_remoteuserformat', 'auth_ldap'),
            '',
            PARAM_RAW_TRIMMED
        ));
    }
    ...
    if (function_exists('ldap_connect')) {
        ...
        $settings->add(new admin_setting_configselect(
            'auth_ldap_syncplus/sync_authtype',
            new lang_string('sync_authtype', 'auth_ldap_syncplus'),
            new lang_string('sync_authtype_desc', 'auth_ldap_syncplus'),
            'ldap_syncplus',
            $moodleauthtypeoptions
        ));
        ...
        $scopenotification = new \core\output\notification(
            get_string('sync_scope_note', 'auth_ldap_syncplus'),
            \core\output\notification::NOTIFY_WARNING
        );
        ...
        $settings->add(new auth_ldap_admin_setting_special_lowercase_configtext(
            'auth_ldap_syncplus/sync_filter',
            new lang_string('sync_filter', 'auth_ldap_syncplus'),
            new lang_string('sync_filter_desc', 'auth_ldap_syncplus', $defaultfilter),
            '',
            PARAM_RAW_TRIMMED
        ));
