...
$string['sync_scope_useradderror'] = 'Skipping the user with username "{$a}". The username is empty or the username is equal to the configured sync scope. This must not happen.';
